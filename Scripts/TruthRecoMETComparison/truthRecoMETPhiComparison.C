...
outputTree->Draw("MET_phi-truthMET_Phi>>hee(40,-1,1)",region + "channel==1")
outputTree->Draw("MET_phi-truthMET_Phi>>hmm(40,-1,1)",region + "channel==0")
outputTree->Draw("MET_phi-truthMET_Phi>>hem(40,-1,1)",region + "channel>=2")
hem->Scale(0.5)
hee->SetLineColor(2)
hmm->SetLineColor(4)
hem->SetLineColor(8)
...
hmm->SetStats(0)
hem->SetStats(0)
hee->SetTitle("MET_phi-truthMET_Phi " + regionName)
hmm->SetTitle("MET_phi-truthMET_Phi " + regionName)
hem->SetTitle("MET_phi-truthMET_Phi " + regionName)
hee->Draw()
hmm->Draw("same")
hem->Draw("same")
g1 = new TF1("m1","gaus");
