...
//void addWeight( string pathToNtuples = "/afs/cern.ch/user/b/benhoob/workspace/ZMETSamples/Current_Ntuples/v00-17-nosyst/p2421" ){
void addWeight( string pathToNtuples = "/afs/cern.ch/work/m/mazhang/Data/v21_Sys/") {
  ...
  for (int i=0; i<treeNames.size(); i++) {
	  ...
	  //addWeightsToSample("342556",pathToNtuples,treeName);
	  //addWeightsToSample("361063",pathToNtuples,treeName);
	  //addWeightsToSample("361064",pathToNtuples,treeName);
	  //addWeightsToSample("361065",pathToNtuples,treeName);
	  addWeightsToSample("361066",pathToNtuples,treeName);
	  //addWeightsToSample("361067",pathToNtuples,treeName);
	  //addWeightsToSample("361068",pathToNtuples,treeName);
	  //addWeightsToSample("361071",pathToNtuples,treeName);
	  //addWeightsToSample("361072",pathToNtuples,treeName);
	  //addWeightsToSample("361073",pathToNtuples,treeName);
	  //addWeightsToSample("361077",pathToNtuples,treeName);
	  //addWeightsToSample("361084",pathToNtuples,treeName);
	  //addWeightsToSample("361086",pathToNtuples,treeName);
	  //addWeightsToSample("361600",pathToNtuples,treeName);
	  //addWeightsToSample("361601",pathToNtuples,treeName);
	  //addWeightsToSample("361603",pathToNtuples,treeName);
	  //addWeightsToSample("361604",pathToNtuples,treeName);
	  //addWeightsToSample("361607",pathToNtuples,treeName);
	  //addWeightsToSample("361610",pathToNtuples,treeName);
	  //addWeightsToSample("410066",pathToNtuples,treeName);
	  //addWeightsToSample("410067",pathToNtuples,treeName);
	  //addWeightsToSample("410068",pathToNtuples,treeName);
	  //addWeightsToSample("410081",pathToNtuples,treeName);
	  //addWeightsToSample("410111",pathToNtuples,treeName);
	  //addWeightsToSample("410112",pathToNtuples,treeName);
	  //addWeightsToSample("410113",pathToNtuples,treeName);
	  //addWeightsToSample("410114",pathToNtuples,treeName);
	  //addWeightsToSample("410115",pathToNtuples,treeName);
	  //addWeightsToSample("410116",pathToNtuples,treeName);
  }
  ...
  sampleID.push_back("410000_p2421");
  ...
  */
  ...
  // no mu_pT branches:
   ...
   //for( int i = 361372 ; i <= 361443 ; i++ ){
	 ...
	 //addWeightsToSample(to_string(i),pathToNtuples,"outputTree");
   //}
  ...
  //   if( i == 361485 ) continue;
  //   if( i == 361478 ) continue;
  //   if( i == 361484 ) continue;
